<%@ Page Title="" Language="C#" MasterPageFile="~/yonetici.Master" AutoEventWireup="true" CodeBehind="kullanici_guncelle.aspx.cs" Inherits="BitkilerHastaliklarStaj.kullanici_guncelle" %>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td><asp:HyperLink ID="HyperLink2" 
                        NavigateUrl='<%# "~/kullanici_guncelle_teyit.aspx?kullanici_id="+Eval("kullanici_id")%>'
