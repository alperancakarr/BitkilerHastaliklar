<%@ Page Title="" Language="C#" MasterPageFile="~/yonetici.Master" AutoEventWireup="true" CodeBehind="bitki_ekle.aspx.cs" Inherits="BitkilerHastaliklarStaj.bitki_ekle" %>
  ...
  margin-right: auto;
    ...
    <form class="" runat="server" >
        <table class="center">
            ...
            <tr>
                <h2 style="width:80%; color:white">Bitki Ekleme</h2>
            </tr>
            <div>
                <br />
            </div>
