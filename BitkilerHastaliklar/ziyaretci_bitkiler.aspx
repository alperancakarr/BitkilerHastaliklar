<%@ Page Title="" Language="C#" MasterPageFile="~/ziyaretci.Master" AutoEventWireup="true" CodeBehind="ziyaretci_bitkiler.aspx.cs" Inherits="BitkilerHastaliklarStaj.ziyaretci_bitkiler" %>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td><asp:HyperLink ID="HyperLink2" 
                        NavigateUrl='<%# "~/ziyaretci_bitki_detay.aspx?bitki_id="+Eval("bitki_id")%>'
