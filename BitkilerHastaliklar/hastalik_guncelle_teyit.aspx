<%@ Page Title="" Language="C#" MasterPageFile="~/yonetici.Master" AutoEventWireup="true" CodeBehind="hastalik_guncelle_teyit.aspx.cs" Inherits="BitkilerHastaliklarStaj.hastalik_guncelle_teyit" %>
  ...
  margin-right: auto;
    ...
    <form class="" runat="server" >
        <table class="center">
            ...
            <tr>
                <asp:TextBox class="text" type="text" ID="hastalik_id_kutusu" runat="server" placeholder="Hastalık ID"></asp:TextBox>
            </tr>
            <tr>
