<%@ Page Title="" Language="C#" MasterPageFile="~/yonetici.Master" AutoEventWireup="true" CodeBehind="hastalik_guncelle.aspx.cs" Inherits="BitkilerHastaliklarStaj.hastalik_guncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <div align="center">
        <div><br /></div>
                <h2 style="width:80%; color:white">Hastalık Güncelleme</h2>
    <div><br /></div>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td><asp:HyperLink ID="HyperLink2" 
                        NavigateUrl='<%# "~/hastalik_guncelle_teyit.aspx?hastalik_id="+Eval("hastalik_id")%>'
                        runat="server" CssClass="button button1">Güncelle</asp:HyperLink></td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
