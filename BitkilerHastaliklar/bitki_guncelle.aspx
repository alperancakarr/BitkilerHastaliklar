<%@ Page Title="" Language="C#" MasterPageFile="~/yonetici.Master" AutoEventWireup="true" CodeBehind="bitki_guncelle.aspx.cs" Inherits="BitkilerHastaliklarStaj.bitki_guncelle" %>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td><asp:HyperLink ID="HyperLink2" 
                        NavigateUrl='<%# "~/bitki_guncelle_teyit.aspx?bitki_id="+Eval("bitki_id")%>'
