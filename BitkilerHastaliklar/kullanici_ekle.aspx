<%@ Page Title="" Language="C#" MasterPageFile="~/yonetici.Master" AutoEventWireup="true" CodeBehind="kullanici_ekle.aspx.cs" Inherits="BitkilerHastaliklarStaj.kullanici_ekle" %>
  ...
  margin-right: auto;
    ...
    <form class="" runat="server" >
        <table class="center">
            ...
            <tr>
                <h2 style="width:80%; color:white">Kullanıcı Ekleme</h2>
            </tr>
            <div>
                <br />
            </div>
            ...
            <tr>
                <asp:DropDownList ID="kullanici_tipi" runat="server" Height="40px">
